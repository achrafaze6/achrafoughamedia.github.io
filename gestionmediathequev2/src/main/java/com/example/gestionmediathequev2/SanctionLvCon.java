...
public class SanctionLvCon {
    ...
    @FXML
    void getacteur(MouseEvent event) throws SQLException {
        cnx = Connectionmysql.connectionDB();
        st1= cnx.prepareStatement("delete from sanctionl where idadr=?");
    ...
    void setData(Adherent adherent) throws SQLException {
        ...
        cnx = Connectionmysql.connectionDB();
        st=cnx.prepareStatement("select montant from sanctionl where sanctionl.idadr =?;");
        ...
        nrea.setText(String.valueOf(sccd) +"  DH");
