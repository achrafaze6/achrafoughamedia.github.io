...
public class SanctionfdataCn {
    ...
    void deleacteur(MouseEvent event) throws SQLException {
        ...
        st1= cnx.prepareStatement("delete from sanctiondvd where idadr=?");
    ...
    void setData(Adherent adherent) throws SQLException {
        ...
        cnx = Connectionmysql.connectionDB();
        st=cnx.prepareStatement("select montant from sanctiondvd where sanctiondvd.idadr =? ;");
